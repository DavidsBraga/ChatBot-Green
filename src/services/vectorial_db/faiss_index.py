...
class FAISSIndex():
    ...
    def ingest_text(self, text: str | None = None, text_chunks: list | None = None, metadata: dict | None = None) -> bool:
        """
        ...
        for chunk in text_chunks:
            ...
            self.metadata_list += [{"chunk_index": len(self.chunks_list) - 1,**(metadata or {})}]
    ...
    def save_index(self, path=r"./faiss_index"):
        ...
        np.save(os.path.join(path, "metadata.npy"), self.metadata_list) 
    ...
    def load_index(self, path: str = r"./faiss_index"):
        ...
        self.metadata_list = np.load(os.path.join(path, "metadata.npy"), allow_pickle=True).tolist()
